...
public class ExcelWriting {
	...
	public int EmployeeData(int rowcount, List<WebElement> contact_Names,List<WebElement> contact_Links) throws IOException
	{
		int count =1;
		...
		{	        
			...
			FileOutputStream fout=new FileOutputStream(new File("D:/workspace/linkedin/output.xlsx"));
			workbook.write(fout);
			fout.close();
